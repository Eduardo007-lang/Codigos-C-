...
namespace TP1.View
{
    public partial class PlotterGraphPaneEx : UserControl
    {
        ...
        public float grid_distance_x = 200;       
        public float grid_off_x = 0;
        public float GraphCaptionLineHeight = 28;

        public float pad_inter = 4;         
        public float pad_left = 10;        
        public float pad_right = 10;      
        public float pad_top = 10;         
        public float pad_bot = 10;         

        public float graph_distance_x = 10; 
        public float graph_distance_y = 10; 

        public float yLabelAreaWidth = 40;      

        public float xLabelAreaheight = 8;     
            ...
            foreach (DataSource source in sources)
            {
                ...
                if (source.Active)
                {
                    if (source.AutoScaleY == true)
                    {
                        ...
                        {
                            float data_range = ymax - ymin;              
                            float delta_range = ymax_range - ymin_range; 
